...
RUN apt-get update && \
    apt-get install -y wget=1.20.3-1ubuntu1 unzip=6.0-25ubuntu1 && \    wget https://github.com/nicholasjackson/fake-service/releases/download/v${VERSION}/fake_service_linux_amd64.zip && \
